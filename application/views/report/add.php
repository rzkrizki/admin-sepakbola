            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <input type="date" class="form-control" id="tanggal_pertandingan" name="tanggal_pertandingan" value="<?= $schedule->tanggal_pertandingan ?>" readonly>
                    </div>
                    <div class="col-md-3">
                        <label for="waktu_pertandingan">Waktu Pertandingan</label>
                        <input type="time" class="form-control" id="waktu_pertandingan" name="waktu_pertandingan" value="<?= $schedule->waktu_pertandingan ?>" readonly>
                    </div>
                    <div class="col-md-3">
                        <label for="tim_tuan_rumah">Tim Tuan Rumah</label>
                        <input type="input" class="form-control" id="tim_tuan_rumah" name="tim_tuan_rumah" value="<?= $schedule->tim_tuan_rumah ?>" readonly>
                    </div>
                    <div class="col-md-3">
                        <label for="tim_tamu">Tim Tamu</label>
                        <input type="input" class="form-control" id="tim_tamu" name="tim_tamu" value="<?= $schedule->tim_tamu ?>" readonly>
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="time" step="1" class="form-control" id="time_score" name="time_score">
                    </div>
                </div>
                <div class="mt-4">
...
<script>
    ...
    function checkData() {
        var schedule_id = '<?= $_GET['schedule_id'] ?>'
