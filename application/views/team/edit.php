            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="nama_tim" name="nama_tim" value="<?= $result->nama_tim ?>">
                    </div>
                    <div class="col-md-4">
                        <label for="logo_tim">Logo Tim</label>
                        <input type="text" class="form-control" id="logo_tim" name="logo_tim" value="<?= $result->logo_tim ?>">
                    </div>
                    <div class="col-md-4">
                        <label for="tahun_berdiri">Tahun Berdiri</label>
                        <input type="number" class="form-control" id="tahun_berdiri" name="tahun_berdiri" value="<?= $result->tahun_berdiri ?>">
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-md-4">
                        <label for="alamat_markas_tim">Alamat Markas Tim</label>
                        <textarea name="alamat_markas_tim" id="alamat_markas_tim" cols="30" rows="10" class="form-control" value="<?= $result->alamat_markas_tim ?>"><?= $result->alamat_markas_tim ?></textarea>
                    </div>
                    <div class="col-md-4">
                        <label for="kota_markas_tim">Kota Markas Tim</label>
                        <input type="text" class="form-control" id="kota_markas_tim" name="kota_markas_tim" value="<?= $result->kota_markas_tim ?>">
                    </div>
                </div>
                <div class="mt-4">
