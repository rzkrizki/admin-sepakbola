                    ...
                    <div class="col-md-4">
                        ...
                        <select name="team_id" id="team_id" class="form-control" required>
                            ...
                            <?php foreach($team as $row){ ?>
                                <option value="<?= $row->id ?>" <?php if($result->team_id == $row->id) { echo "selected" ;} ?>><?= $row->nama_tim ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="col-md-4">
                        <label for="nama_pemain">Nama Pemain</label>
                        <input type="text" class="form-control" id="nama_pemain" name="nama_pemain" value="<?= $result->nama_pemain ?>">
                    </div>
                    <div class="col-md-4">
                        <label for="tinggi_badan">Tinggi Badan</label>
                        <input type="number" class="form-control" id="tinggi_badan" name="tinggi_badan" value="<?= $result->tinggi_badan ?>">
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-md-4">
                        <label for="berat_badan">Berat Badan</label>
                        <input type="number" class="form-control" id="berat_badan" name="berat_badan" value="<?= $result->berat_badan ?>">
                    </div>
                    <div class="col-md-4">
                        <label for="posisi_pemain">Posisi Pemain</label>
                        <select name="posisi_pemain" id="posisi_pemain" class="form-control" required>
                            <option value="">Pilih Salah Satu</option>
                            <option value="penyerang" <?php if($result->posisi_pemain == 'penyerang') { echo "selected" ;} ?>>Penyerang</option>
                            <option value="gelandang" <?php if($result->posisi_pemain == 'gelandang') { echo "selected" ;} ?>>Gelandang</option>
                            <option value="bertahan" <?php if($result->posisi_pemain == 'bertahan') { echo "selected" ;} ?>>Bertahan</option>
                            <option value="penjaga_gawang" <?php if($result->posisi_pemain == 'penjaga_gawang') { echo "selected" ;} ?>>Penjaga Gawang</option>
                        </select>
                    </div>
                    <div class="col-md-4">
                        <label for="nomor_punggung">Nomor Punggung</label>
                        <input type="text" class="form-control" id="nomor_punggung" name="nomor_punggung" value="<?= $result->nomor_punggung ?>">
                    </div>
                </div>
                <div class="mt-4">
