            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <input type="date" class="form-control" id="tanggal_pertandingan" name="tanggal_pertandingan">
                    </div>
                    <div class="col-md-3">
                        <label for="waktu_pertandingan">Waktu Pertandingan</label>
                        <input type="time" class="form-control" id="waktu_pertandingan" name="waktu_pertandingan">
                    </div>
                    <div class="col-md-3">
